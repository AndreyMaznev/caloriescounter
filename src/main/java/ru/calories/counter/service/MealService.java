...
import ru.calories.counter.repository.MealRepository;

import java.time.LocalDate;
import java.util.List;

import static ru.calories.counter.util.DateTimeUtil.atStartOfDayOrMin;
import static ru.calories.counter.util.DateTimeUtil.atStartOfNextDayOrMax;
