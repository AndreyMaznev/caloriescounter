...
<%@ taglib prefix="fn" uri="http://caloriescounter.ru/functions" %>
<html>
<jsp:include page="fragments/headTag.jsp"/>
<body>
<script type="text/javascript" src="resources/js/caloriescounter.common.js" defer></script>
<script type="text/javascript" src="resources/js/caloriescounter.meals.js" defer></script>
